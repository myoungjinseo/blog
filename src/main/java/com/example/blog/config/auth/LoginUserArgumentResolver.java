...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    @Override
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,        //파라미터에 전달할 객체를 생성
                                  NativeWebRequest webRequest, WebDataBinderFactory binderFactory) {
        return httpSession.getAttribute("user");        //여기서는 세션에서 객체를 가져옴
    }
}
